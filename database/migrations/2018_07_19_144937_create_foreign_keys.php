...
class CreateForeignKeys extends Migration {
    ...
    public function up()
    {
        ...
        Schema::table('creation_champ', function(Blueprint $table) {
            $table->foreign('type_champ_id')->references('id')->on('type_champ')
                        ->onDelete('restrict')
                        ->onUpdate('restrict');
        });
        Schema::table('champ_habitat', function(Blueprint $table) {
            $table->foreign('habitat_id')->references('id')->on('habitat')
                        ->onDelete('restrict')
                        ->onUpdate('restrict');
        });
        Schema::table('champ_habitat', function(Blueprint $table) {
            $table->foreign('champ_id')->references('id')->on('creation_champ')
                        ->onDelete('restrict')
                        ->onUpdate('restrict');
    });
    ...
    public function down()
    {
        ...
        Schema::table('creation_champ', function(Blueprint $table) {
            $table->dropForeign('creation_champ_type_champ_id_foreign');
        });
        Schema::table('champ_habitat', function(Blueprint $table) {
            $table->dropForeign('champ_habitat_habitat_id_foreign');
        });
        Schema::table('champ_habitat', function(Blueprint $table) {
            $table->dropForeign('champ_habitat_champ_id_foreign');
        });
    }
}